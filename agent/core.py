...
class Agent:
    ...
    def _cmd_start(self, ctx: AgentContext) -> str:
        return (
            f"{_wat_greeting()}! 👋\n\n"
            "I'm *Àkànjí Oníṣòwò* — a Yoruba-named crypto trading agent.\n\n"
            "*Oníṣòwò* means *trader* in Yoruba. The full name literally means "
            "*\"the trader\"* — one who knows the market, who sees the move before it moves.\n\n"
            "I trade on Bitget, powered by *Qwen 3.6 Plus*. "
            "I have 132 skills, MEV awareness, sybil scoring, "
    ...
    def _cmd_intro(self, ctx: AgentContext) -> str:
        """Brief intro — what this bot is, what it does, who built it."""
        return (
            "*Àkànjí Oníṣòwò — A Yoruba trading agent.*\n\n"
            "*Oníṣòwò* is the Yoruba word for *trader* — one who trades, who knows "
            "the market, who sees the move before it moves. The name literally means "
            "*\"the trader.\"*\n\n"
            "I'm a digital trader built for Bitget. "
            "Powered by *Qwen 3.6 Plus* with 132 skills covering: "
            "MEV-aware execution, sybil counterparty scoring, "
            "recursive self-improvement, adaptive TP/SL, "
            "regime detection, and more.\n\n"
            "Built by *Àkànjí* (Ruzkypazzy) — a West African trader "
            "who knows that the old markets and the new markets speak the same language.\n\n"
            "_Type `/start` for quick start, or just send a prompt — e.g. `buy 2 SOL`._"
        )
