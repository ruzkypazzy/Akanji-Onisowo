...
class Agent:
    ...
    def _cmd_start(self, ctx: AgentContext) -> str:
        return (
            ...
            "I trade crypto on Bitget with 100+ skills, MEV awareness, "
            "sybil scoring, and a memory that learns from every trade.\n\n"
            "*Quick start:*\n"
    ...
    def _cmd_about(self, ctx: AgentContext) -> str:
        ...
        return (
            ...
            "*Differentiation:*\n"
            "• 100+ skills (vs typical 5-10)\n"
            "• MEV-aware execution\n"
            "• Sybil counterparty scoring\n"
            "• Recursive self-improvement (memory that tunes itself)\n"
